// CriticalSectionSync.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
// CRITICAL_SECTION hCriticalSection; // 화장실 열쇠 선언, 반드시 초기화 과정을 거쳐야 한다. 
HANDLE hMutex;
...
int _tmain(int argc, TCHAR* argv[])
{
    ...
    // InitializeCriticalSection(&hCriticalSection);   // 화장실 열쇠 초기화
