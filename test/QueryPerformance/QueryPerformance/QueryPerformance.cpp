// QueryPerformance.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
void StartCounter()
{
    ...
    PCFreq = double(li.QuadPart) / 10000;
...
int main()
{
    ...
    DeltaTime = (end.QuadPart - start.QuadPart) / (double)timer.QuadPart;
