...
private:
	...
	{
#ifdef _DEBUG
		unsigned int magicNumber;	// 디버그 모드에서 안전장치 작동
#endif // _DEBUG
		DATA data;
		st_BLOCK_NODE* pNextNode;
	};
...
template<class DATA>
inline CMemoryPool<DATA>::CMemoryPool(int iBlockNum, bool bPlacementNew) : m_iCapacity(iBlockNum), m_iUseCount(0), _pFreeNode(nullptr)
{
	int iCnt;
